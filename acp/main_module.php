...
class main_module
{
	...
	/** @var \alfredoramos\share\controller\acp */
	...
	public function __construct()
	{
		...
		$this->acp_controller = $phpbb_container->get('alfredoramos.share.controller.acp');
	}
	...
	{
		// Load translations
		$this->language->add_lang('acp/settings', 'alfredoramos/share');

		// Form token
		add_form_key('alfredoramos_share');

		switch ($mode)
		{
			case 'settings':
				$this->tpl_name = 'acp_share_settings';
				$this->page_title = sprintf(
					'%s - %s',
					$this->language->lang('SETTINGS'),
					$this->language->lang('ACP_SHARE')
				);
